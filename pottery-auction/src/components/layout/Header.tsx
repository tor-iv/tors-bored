              ...
              <div className="flex items-center gap-6">
                ...
                <nav className="hidden md:flex gap-8">
                  {navItems.map((item) => (
                    <Link
                      key={item.href}
                      href={item.href}
                      className="text-sm hover-wobbly transition-opacity"
                ...
                {isAuthenticated ? (
                  <div className="flex items-center gap-4">
                    {userProfile?.isAdmin && (
                      <Link href="/admin" className="text-sm hover-wobbly" style={{ color: 'var(--ink)' }}>
                        Admin
                      </Link>
                    )}
                    <Link href="/account" className="text-sm hover-wobbly" style={{ color: 'var(--ink)' }}>
                      Account
                    </Link>
                    <button
                      onClick={handleSignOut}
                      className="text-sm hover-wobbly"
                      style={{ color: 'var(--ink-muted)' }}
                    >
                      Sign out
                    </button>
